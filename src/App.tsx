            ...
            {isNotificationsOpen && (
              <>
                ...
                <motion.div 
                  ...
                  className="fixed inset-x-4 top-[72px] sm:inset-x-auto sm:right-4 lg:right-8 sm:top-[72px] sm:w-96 bg-background ledger-card shadow-2xl z-50 overflow-hidden"
                >
